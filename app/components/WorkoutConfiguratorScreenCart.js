    ...
    return (
        ...
        <View style={{ marginTop: RFPercentage(2), width: '90%', height: RFPercentage(18), justifyContent: 'flex-start', alignItems: 'flex-start', backgroundColor: disable ? Colors.purple : Colors.white, borderRadius: RFPercentage(2.2) }} >
            <View style={{ marginTop: RFPercentage(2), marginLeft: RFPercentage(3), flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }} >
                <Ionicons name="md-time-outline" style={{ fontSize: RFPercentage(3.3) }} color={disable ? Colors.white : Colors.primary} />
                <Text style={{ marginLeft: RFPercentage(2), fontFamily: 'Montserrat_600SemiBold', color: disable ? Colors.white : Colors.primary, fontSize: RFPercentage(2.5) }} >
                    {t1}
                </Text>
            </View>
            <View style={{ marginTop: RFPercentage(2), marginLeft: RFPercentage(2), flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }} >
                <Text style={{ marginLeft: RFPercentage(2), fontFamily: 'Montserrat_500Medium', color: disable ? Colors.white : Colors.primary, fontSize: RFPercentage(1.7) }} >
                    {t2}
                </Text>
                <Text style={{ marginLeft: RFPercentage(2.2), fontFamily: 'Montserrat_500Medium', color: disable ? Colors.white : Colors.primary, fontSize: RFPercentage(2.3) }} >
                    {t3}
                </Text>
            </View>
